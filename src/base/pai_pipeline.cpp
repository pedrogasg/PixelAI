...
namespace pai
{
        ...
        const PipelineConfigInfo &configInfo)
    {
        ...
        vkDestroyShaderModule(paiDevice.device(), fragShaderModule, nullptr);
        vkDestroyShaderModule(paiDevice.device(), geomShaderModule, nullptr);
        vkDestroyShaderModule(paiDevice.device(), vertShaderModule, nullptr);
        fragShaderModule = VK_NULL_HANDLE;
    ...
    void PaiPipeline::pixelPipelineConfigInfo(PipelineConfigInfo &configInfo)
    {
        ...
        configInfo.bindingDescriptions = PaiPixel::Vertex::getBindingDescriptions();
        configInfo.attributeDescriptions = PaiPixel::Vertex::getAttributeDescriptions();
    }
